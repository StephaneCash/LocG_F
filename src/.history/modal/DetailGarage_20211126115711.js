                    ...
                    <div>
                        ...
                        <div className="col-md-12">
                            <div className="row">
                                ...
                                <button type="button" className="" style={{border:"1px solid silver", padding:"5px"}}>Voir plus <i className="fa fa-plus"></i></button>
                            </div>
                        </div>
                    </div>
                </Modal.Body>
                <Modal.Footer className="headerModal">
                    <button className="btn btn-primary">Ecrire au garagiste</button>

                                                ...
                                                <td style={{ border: "1px solid #f0f0f0" }}>
                                                    {
                                                        val.specialistes.map((val) => {
                                                            return (
                                                                <>
                                                                    <td style={{ border: "1px solid #f0f0f0" }}>{val.nom} {val.postnom} {val.prenom}
                                                                        {val.telephone}</td>
                                                                </>
                                                            )
                                                        })
                                                ...
                                                <td style={{ border: "1px solid #f0f0f0" }}>
                                                    {
                                                        val.specialites.map((val) => {
                                                            return (
                                                                <td style={{ border: "1px solid #f0f0f0" }}>{val.nom} , { val.description}</td>
                                                            )
                                                        })
                                                    }
                                                </td>
                                                <td style={{ border: "1px solid #f0f0f0" }}>{ val.description}</td>
                                            </tr>
                                        )
                                    }
                                })
